  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-lg mx-auto aspect-square relative p-4 rounded-[40px] md:rounded-[60px] overflow-hidden bg-white/90 dark:bg-black/80 backdrop-blur-3xl border-[4px] md:border-[6px] border-white dark:border-slate-900 shadow-[0_24px_64px_-12px_rgba(0,0,0,0.3)] text-slate-800 dark:text-white transition-all duration-500">
      ...
      <div className="absolute bottom-10 w-full flex items-center justify-center gap-8 px-10">
        <button 
          onClick={onCancel}
          className="w-14 h-14 rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 flex items-center justify-center text-slate-500 dark:text-slate-300 transition-all active:scale-95"
          title="إلغاء المقطع"
        >
